...
$string['apiurl'] = 'Session API to generate transaction';
$string['requestedurl'] = 'Validation API (Web Service) name';
$string['requestedurl_help'] = 'Validation api url without parameter';
$string['storeid'] = 'Store ID';
$string['storepassword'] = 'Store Password (API/Secret Key)';
